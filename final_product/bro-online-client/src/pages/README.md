...
On the app, please create a group and click on it, which will lead you to the Group Page. Then, click a button which says “Add member” which will lead you to a search page from there, you can choose people that you want to your group. After you have chosen a person, it will redirect you back to the Group Page and the chosen person would be display.
